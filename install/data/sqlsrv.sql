...
'TABLE', N'{[FoundPHP]}article_data'
GO
INSERT INTO [dbo].[{[FoundPHP]}article_data] ([adid], [cate_id], [aid], [uid], [cases], [subject], [content], [md_content], [cache], [author], [dateline], [page_num]) VALUES (N'1', N'1687', N'1', N'1', N'phpcourse', N'FoundPHP 为你的梦想加油！', N'<h1 id=&quot;h1--foundphp-&quot;><a name=&quot;欢迎来到FoundPHP 开发世界&quot; class=&quot;reference-link&quot;></a><span class=&quot;header-link octicon octicon-link&quot;></span>欢迎来到FoundPHP 开发世界</h1><p>FoundPHP 是目前唯一同时运行PHP5/PHP7/PHP8的开发框架，用简单的方法为您实现最实用、最稳定的开发平台。</p>
...
GO
EXEC sp_addextendedproperty
'MS_Description', N'文章类型 （phpcourse）',
'SCHEMA', N'dbo',
'TABLE', N'{[FoundPHP]}articles_relation',
'COLUMN', N'genres'
GO

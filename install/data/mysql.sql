...
INSERT INTO `{[FoundPHP]}articles` VALUES (1, 1, 1687, NULL, 'zh', '欢迎来到FoundPHP 开发世界', NULL, 'FoundPHP 框架是非常优秀的PHP开发框架', '', 'FoundPHP 是目前唯一同时运行PHP5/PHP7/PHP8的开发框架。', '', '', '', 'http://www.foundphp.com', 'Admin', '', 'articles', 1612411395, 1612411515, 0, 1);
...
CREATE TABLE `{[FoundPHP]}articles_relation`  (
  ...
  `genres` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '文章类型 （articles）',
  `aid` int(11) NOT NULL DEFAULT 0 COMMENT '文章id',
